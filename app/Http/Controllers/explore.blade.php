...
<html lang="en">
  ...
  <body>
    <div>
      <link href="./productdashbaord.css" rel="stylesheet" />
      ...
      <div class="productdashbaord-container">
        <header data-role="Header" class="productdashbaord-header">
          ...
          <div class="productdashbaord-btn-group">
            <a
              ...
              id="loginbtn"
              class="productdashbaord-login button"
            >
              Login
            </a>
            <a
        ...
        <div class="productdashbaord-container01">
          <div class="productdashbaord-container02">
            <div class="productdashbaord-container03">
              ...
              <div class="productdashbaord-container06">
                ...
                <select id="filterselect" class="productdashbaord-select">
            ...
            <div class="productdashbaord-container07">
              <div id="productcont1" class="productcontainer-productcontainer">
                <img
                  id="productimg"
                  alt="image"
                  src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?ixid=Mnw5MTMyMXwwfDF8c2VhcmNofDF8fGJ1cmdlcnxlbnwwfHx8fDE2NjgwODgyMDM&amp;ixlib=rb-4.0.3&amp;w=300"
                  class="productcontainer-image"
                />
                <span id="productitle" class="productcontainer-text">
                  <span>Burger</span>
                </span>
                <span id="productprice" class="productcontainer-text1">
                  <span>Rs. 100</span>
                </span>
                <span id="productdescription" class="productcontainer-text2">
                  <span>description</span>
                </span>
                <a
                  href="product-page.html"
                  id="productlink"
                  class="productcontainer-navlink"
                >
